            ...
            <div>
                ...
                <div className='body'>
                    ...
                    <div className='body-left'>
                        <ul>
                            <li><a href='#' onClick={this.setTypeWork.bind(this)}>work</a></li>
                            <li><a href='#' onClick={this.setTypeNotes.bind(this)}>notes</a></li>
                            <li><a href='#' onClick={this.setTypeDo.bind(this)}>do</a></li>
                        </ul>
                    </div>
